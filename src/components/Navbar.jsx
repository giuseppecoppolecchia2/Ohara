...
export default function Navbar({ onBurgerClick, sidebarOpen }) {
  ...
  return (
    <div className="navbar bg-[#0B212E] shadow-lg px-4 sticky top-0 z-40 border-b border-[#e8d8b5]/20 h-14">
      ...
      >
        <span
          className={`block w-[15px] h-[1.5px] bg-[#e8d8b5] rounded-full transition-all duration-200 origin-center
          ${sidebarOpen ? "translate-y-[6px] rotate-45" : ""}`}
        />
        <span
          className={`block w-[15px] h-[1.5px] bg-[#e8d8b5] rounded-full transition-all duration-200
    ...
    ${user ? "tooltip overflow-hidden tooltip-bottom before:text-xs before:bg-[#1a3547] before:text-[#e8d8b5] before:border before:border-[#e8d8b5]/60" : ""}`}
          >
            {user ? (
              <img
                src={avatarUrl ?? "https://picsum.photos/200/300"}
          ...
          <ul
            className="dropdown-content menu bg-[#0b212e] border border-[#e8d8b5]/20
            ...
            {!user ? (
              <>
                <li>
                  <Link
                    to={routes.login}
                    className="text-[13px] text-[#e8d8b5]/75 hover:text-[#e8d8b5] hover:bg-[#e8d8b5]/8 rounded-lg"
                  >
              ...
              <>
                ...
                <li>
                  <button
                    ...
                    className="text-[13px] text-red-400/80 hover:text-red-400 hover:bg-red-400/8 rounded-lg w-full text-left flex items-center gap-2 px-3 py-2"
                  >
